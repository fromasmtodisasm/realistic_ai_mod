...
//
//////////////////////////////////////////////////////////////////////
#ifndef _SCOUTCOMBATSTATE_H_
#define _SCOUTCOMBATSTATE_H_
#include <map>
#include <vector>
#include "EnemySighting.h"
class CScoutCombatState
{
public:
//! Constructors
CScoutCombatState( void ) : m_nId(0), m_fElapsedTime(0.0), m_bInPosn(false) {}
CScoutCombatState( int id, float time, bool flag ) : m_nId(id), m_fElapsedTime(time),
m_bInPosn(flag) {}
//! Destructor
virtual ~CScoutCombatState( void );
