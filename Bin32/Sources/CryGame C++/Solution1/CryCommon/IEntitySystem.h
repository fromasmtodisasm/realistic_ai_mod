...
//  Description: Interface to the entity system.
//
//  History:
...
/*!	Retrieves the unique identifier of this entity assigned to it by the Entity System.
	@return The entity id as an unsigned short if successful. This function always succeeds if a pointer to the interface is acquired.
*/
