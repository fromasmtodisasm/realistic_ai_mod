...
function Mission:OnInit()
	...
	Language:LoadStringTable("specops04.xml");
	Hud:FlashObjectives({},"");
...
function Mission:Event_M_Avia_Carrier()
	Hud:SetRadarObjective("Radar_Avia");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:PushObjective({},Localize("Entrance_Catacomb"));
	Hud:PushObjective({},Localize("Go_To_Carrier"));
	_localplayer.cnt.health=_localplayer.cnt.max_health;
	_localplayer.cnt.armor=_localplayer.cnt.max_armor;		 
end


function Mission:Event_M_Team_Together()
	Hud:SetRadarObjective("Radar_Together");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:CompleteObjective(Localize("Go_To_Carrier"));
	Hud:PushObjective({},Localize("Return_To_All4"));		 
end

function Mission:Event_M_Goto_Kamp()
	Hud:SetRadarObjective("Radar_Kamp");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:CompleteObjective(Localize("Return_To_All4"));
	Hud:PushObjective({},Localize("Engage_To_Kamp4"));
end

function Mission:Event_M_Goto_Catacomb()
	Hud:SetRadarObjective("Radar_Catacomb");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:CompleteObjective(Localize("Engage_To_Kamp4"));
	Hud:PushObjective({},Localize("Find_Catac_Ent"));
end
...
function Mission:Event_MoveToHamvee()	
