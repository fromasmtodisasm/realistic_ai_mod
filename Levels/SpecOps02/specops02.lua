...
function Mission:OnInit()
	...
	Language:LoadStringTable("specops02.xml");
	Hud:FlashObjectives({},"");
...
function Mission:Event_New_Mis()
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:PushObjective({},Localize("Bunker_Road"));
	_localplayer.cnt.health=_localplayer.cnt.max_health;
	_localplayer.cnt.armor=_localplayer.cnt.max_armor;
end

function Mission:Event_Sniper_Tower()
	Hud:SetRadarObjective("Radar_Sniper");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:PushObjective({},Localize("Sniper_Holm"));
end

function Mission:Event_Kamp_Engage()
	Hud:SetRadarObjective("Radar_Kamp");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:CompleteObjective(Localize("Sniper_Holm"));
	Hud:PushObjective({},Localize("Go_To_Kamp2"));
end

function Mission:Event_Goto_Bunker()
	Hud:SetRadarObjective("Radar_Bunker");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:CompleteObjective(Localize("Go_To_Kamp2"));
	Hud:PushObjective({},Localize("Go_To_Entrance"));
end
...
function Mission:Event_MoveToRiver()	
	local DummyDooch=System:GetEntityByName("Dooch_River_RELOCATE");	
	local DummyLock=System:GetEntityByName("Lock_River_RELOCATE");	
	local DummyDen=System:GetEntityByName("Den_River_RELOCATE");
	local AIDooch=System:GetEntityByName("Dooch");
	local AILock=System:GetEntityByName("Lock");
	local AIDen=System:GetEntityByName("Den");
	if((DummyDooch)and(AIDooch))then
...
function Mission:Event_MoveToBridge()	
	local DummyDooch=System:GetEntityByName("Dooch_Bri_RELOCATE");	
	local DummyLock=System:GetEntityByName("Lock_Bri_RELOCATE");	
	local DummyDen=System:GetEntityByName("Den_Bri_RELOCATE");
	local AIDooch=System:GetEntityByName("Dooch");
	local AILock=System:GetEntityByName("Lock");
	local AIDen=System:GetEntityByName("Den");
	if((DummyDooch)and(AIDooch))then
...
function Mission:Event_MoveToLagera()	
	local DummyDooch=System:GetEntityByName("Dooch_Bera_RELOCATE");	
	local DummyLock=System:GetEntityByName("Lock_Bera_RELOCATE");	
	local DummyDen=System:GetEntityByName("Den_Bera_RELOCATE");
	local AIDooch=System:GetEntityByName("Dooch");
	local AILock=System:GetEntityByName("Lock");
	local AIDen=System:GetEntityByName("Den");
	if((DummyDooch)and(AIDooch))then
...
function Mission:Event_MoveToLesera()	
	local DummyDooch=System:GetEntityByName("Dooch_Lese_RELOCATE");	
	local DummyLock=System:GetEntityByName("Lock_Lese_RELOCATE");	
	local DummyDen=System:GetEntityByName("Den_Lese_RELOCATE");
	local AIDooch=System:GetEntityByName("Dooch");
	local AILock=System:GetEntityByName("Lock");
	local AIDen=System:GetEntityByName("Den");
	if((DummyDooch)and(AIDooch))then
