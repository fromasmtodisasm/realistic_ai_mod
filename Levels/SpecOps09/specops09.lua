...
function Mission:OnInit()
	...
	Language:LoadStringTable("specops09.xml");
	Hud:FlashObjectives({},"");
...
function Mission:Event_M_Goto_Nasos()
	Hud:SetRadarObjective("Radar_Nasos");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:PushObjective({},Localize("Statiosos"));
	Hud:PushObjective({},Localize("ClearSta"));
...
function Mission:Event_M_Goto_Road()
	...
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:CompleteObjective(Localize("ClearSta"));
	Hud:PushObjective({},Localize("Vilacamp"));
end

function Mission:Event_M_Need_Boat()
	Hud:SetRadarObjective("Radar_Boad");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:CompleteObjective(Localize("Vilacamp"));
	Hud:PushObjective({},Localize("Finboas"));
end

function Mission:Event_M_Boat_Ok()
	Hud:SetRadarObjective("Radar_Piera");
	Hud:AddMessage(Localize("NewObjective"),9);
	Hud:CompleteObjective(Localize("Finboas"));
	Hud:PushObjective({},Localize("Swimpie"));
end
...
function Mission:Event_MoveToJeep()
	local DummyDooch=System:GetEntityByName("Dooch_Jeep_RELOCATE");	
	local DummyLock=System:GetEntityByName("Lock_Jeep_RELOCATE");	
	local DummyDen=System:GetEntityByName("Den_Jeep_RELOCATE");
...
function Mission:Event_MoveToZaval()
	local DummyDooch=System:GetEntityByName("Dooch_Zava_RELOCATE");	
	local DummyLock=System:GetEntityByName("Lock_Zava_RELOCATE");	
	local DummyDen=System:GetEntityByName("Den_Zava_RELOCATE");
	local AIDooch=System:GetEntityByName("Dooch");
	local AILock=System:GetEntityByName("Lock");
	local AIDen=System:GetEntityByName("Den");
	if((DummyDooch)and(AIDooch))then
...
function Mission:Event_MoveToDerevn()
	local DummyDooch=System:GetEntityByName("Dooch_Dere_RELOCATE");	
	local DummyLock=System:GetEntityByName("Lock_Dere_RELOCATE");	
	local DummyDen=System:GetEntityByName("Den_Dere_RELOCATE");
	local AIDooch=System:GetEntityByName("Dooch");
	local AILock=System:GetEntityByName("Lock");
	local AIDen=System:GetEntityByName("Den");
	if((DummyDooch)and(AIDooch))then
...
function Mission:Event_MoveToParse()
	local DummyDooch=System:GetEntityByName("Dooch_Pars_RELOCATE");	
	local DummyLock=System:GetEntityByName("Lock_Pars_RELOCATE");	
	local DummyDen=System:GetEntityByName("Den_Pars_RELOCATE");
	local AIDooch=System:GetEntityByName("Dooch");
	local AILock=System:GetEntityByName("Lock");
	local AIDen=System:GetEntityByName("Den");
	if((DummyDooch)and(AIDooch))then
