...
UI.PageWaitForKey=
{
	GUI=
	{
		...
		OnUpdate= function(self)
			...
			if szKeyName and tostring(szKeyName)~="esc" and tostring(szKeyName)~=System:GetConsoleKeyName() and tostring(szKeyName)~="pause" then
				Input:BindActionMultipleMaps(UI.PageWaitForKey.Action.name,szKeyName,UI.PageWaitForKey.iBindNumber)
