...
UI.PageOptionsVideo =
{
	GUI =
	{
		...
		-- definition of "Full Screen" check box (allows user to toggle between full screen and windowed mode)
		...
		-- definition of "enable vertical sync" check box
		widget_vsync_text =
		{
			skin = UI.skins.Label,
		...
		widget_vsync =
		{
			...
			-- code specific for "enable vertical sync" check box (separated in user table)
			user =
			{
				-- code (implemented below)
				Initialize = nil,
		...
		-- definition of "Background video" check box
