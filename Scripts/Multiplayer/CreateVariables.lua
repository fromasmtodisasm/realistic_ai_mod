...
Game:CreateVariable("gr_rocket_damage_factor",1)               -- percentage damage rockets due based on default amount 1 = 100%.  .5 = 50%
Game:CreateVariable("gr_oicw_nade_damage_factor",1)						-- percentage damage OICW nades due based on default amount 1 = 100%.  .5 = 50%
Game:CreateVariable("gr_ag36_nade_damage_factor",1)						-- percentage damage AG36 due based on default amount 1 = 100%.  .5 = 50%
...
Game:CreateVariable("gr_runspeed_factor",1)                    -- percentage of run speed based on 1 = default 100% (.5 = 50%)
Game:CreateVariable("gr_stamina_use_run",1)                    -- percentage of stamina depletion when running based on 1 = default 100% (.5 = 50%)
...
Game:CreateVariable("gr_walkspeed_factor",1)                   -- percentage of walk speed based on 1 = default 100% (.5 = 50%)
Game:CreateVariable("gr_swimspeed_factor",1)										-- percentage of swim speed based on 1 = default 100% (.5 = 50%)
Game:CreateVariable("gr_crouchspeed_factor",1)									-- percentage of speed when crouched based on 1 = default 100% (.5 = 50%)
Game:CreateVariable("gr_pronespeed_factor",1)									-- percentage of speed when prone based on 1 = default 100% (.5 = 50%)
Game:CreateVariable("gr_jumpforce_factor",1)                   -- percentage of jump amount based on 1 = default 100% (.5 = 50%)
...
Game:CreateVariable("sv_flood_reset_time",5)                  -- number of seconds until client message count is reset to .
