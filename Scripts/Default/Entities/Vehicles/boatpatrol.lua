...
--------------------------------end------------------------------------
	...
	Properties = {		
		...
		-- the vehicle
		fDmgScaleExplosion = .17,		-- explosions
		fDmgScaleBullet = .5,			-- shooting
...
--	fMass = 2500,
	...
	particles_updatefreq = .07, --initial frequency of updating wheel dust particles and 1st damage partcls
...
-- particles definitions
	...
	WaterSplashes=
			{--WaterSplashes
				...
				start_color = {1,1,1},
				end_color = {1,1,1},
				gravity = {x = 0,y = 0,z = 0}, --default z = -8
				rotation = {x = 0, y = 0, z = 0}, --default z = .5
				speed = 6,
				count = 1,
				size = 10, --it was 15
				size_speed=20,
				lifetime= 18, --default = .5
...
function BoatPatrol:DropDriver()
	VC.DropDriver(self)
end

function BoatPatrol:DropPassengers()
