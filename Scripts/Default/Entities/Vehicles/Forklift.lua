...
--	type = "Vehicle",
	...
	DamageParams = {
		-- fDmgScaleAIBullet = 0,
		-- fDmgScaleAIExplosion = 0,
		fDmgScaleBullet = 0,
		fDmgScaleExplosion = 0,
	},
...
--	CarDefDamage = 	{
--	  hull1 = {zoffset=-.5	},
--		wheel1 = {driving=1,axle=0,len_max=.23,stiffness=0,damping=-.7, surface_id = 69, min_friction=1.8, max_friction=1.8},
--		wheel2 = {driving=1,axle=0,len_max=.23,stiffness=0,damping=-.7, surface_id = 69, min_friction=1.8, max_friction=1.8},
--		wheel3 = {driving=1,axle=1,len_max=.23,stiffness=0,damping=-.7, surface_id = 69, min_friction=1.8, max_friction=1.8},
--		wheel4 = {driving=1,axle=1,len_max=.23,stiffness=0,damping=-.7, surface_id = 69, min_friction=1.8, max_friction=1.8},
--	},
--
--	CarDefNormal = 	{
--	  hull1 = {zoffset=-.5	},
--		wheel1 = {driving=1,axle=0,len_max=.23,stiffness=0,damping=-.3, surface_id = 69, min_friction=1.8, max_friction=1.8},
--		wheel2 = {driving=1,axle=0,len_max=.23,stiffness=0,damping=-.3, surface_id = 69, min_friction=1.8, max_friction=1.8},
--		wheel3 = {driving=1,axle=1,len_max=.23,stiffness=0,damping=-.3, surface_id = 69, min_friction=1.8, max_friction=1.8},
--		wheel4 = {driving=1,axle=1,len_max=.23,stiffness=0,damping=-.3, surface_id = 69, min_friction=1.8, max_friction=1.8},
--	},
	...
	CarDef = {
		...
		steer_speed_scale_min = 1, --steering speed scale at min speed
		--steer_speed_valScale = 1,

		max_steer_v0 = 50, --max steer angle
		--max_steer_kv = 0,
	  ...
	  max_time_step_vehicle = .02,
		sleep_speed_vehicle = .11,
		damping_vehicle = .11,
...
--		hull0 = {mass=1859,flags=0,zoffset=.41	}, -- default mass 1859
		hull1 = {mass=5559,flags=0,zoffset=-.35,yoffset=0	}, -- default mass 2359
		hull2 = {mass=0,flags=1	},
		hull3 = {mass=0,flags=1	},

		wheel1 = {driving=1,axle=0,len_max=.23,stiffness=0,damping=-.3, surface_id = 69, min_friction=1.6, max_friction=1.7},
		wheel2 = {driving=1,axle=0,len_max=.23,stiffness=0,damping=-.3, surface_id = 69, min_friction=1.6, max_friction=1.7},
		wheel3 = {driving=1,axle=1,len_max=.23,stiffness=0,damping=-.3, surface_id = 69, min_friction=1.6, max_friction=1.7},
		wheel4 = {driving=1,axle=1,len_max=.23,stiffness=0,damping=-.3, surface_id = 69, min_friction=1.6, max_friction=1.7},
...
--	counting = nil,
	...
	Properties = {
		...
		ExplosionParams = {
			nDamage = 100,
			fRadiusMin = 2, -- default 12
			fRadiusMax = 10, -- default 70.5
			fRadius = 5, -- default 30
			fImpulsivePressure = 50, -- default 200 Умножается на 2.
		},
