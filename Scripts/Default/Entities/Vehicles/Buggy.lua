...
--	ammoRL = 30,
	...
	--
	DamageParams = {
		-- fDmgScaleAIBullet = .09,
		-- fDmgScaleAIExplosion = .1,
		fDmgScaleBullet = .01,
		fDmgScaleExplosion = .17, --patch2:vehicles must explode with 1 missile --before was .12,

		-- dmgBulletMP = .5, --if this value exist in multiplayer will be used this damage for every bullet , 1
...
--		hull0 = {mass=1859,flags=0,zoffset=.41	}, -- default mass 1859
		--hull1 = {mass=1859,flags=0,zoffset=-.5,yoffset=.0	}, -- default mass 2359
		--hull1 = {mass=1000,flags=0,zoffset=-.5,yoffset=-.7	}, -- default mass 2359
		hull1 = {mass=3500,flags=0,zoffset=-.35,yoffset=-.35	}, --mass:1000 -- default mass 2359
		hull2 = {mass=0,flags=1	},
		hull3 = {mass=0,flags=1	},

		wheel1 = {driving=1,axle=0,can_brake=1,len_max=.40,stiffness=0,damping=-.4, surface_id = 69, min_friction=1, max_friction=1.5},
		wheel2 = {driving=1,axle=0,can_brake=1,len_max=.40,stiffness=0,damping=-.4, surface_id = 69, min_friction=1, max_friction=1.5},
...
--	counting = nil,
	...
	Properties = {
		...
		ExplosionParams = {
			nDamage = 900,
			fRadiusMin = 8, -- default 8
			fRadiusMax = 35.5, -- default 35.5
			fRadius = 13, -- default 30
			fImpulsivePressure = 550, -- default 200 Умножается на 2.
		},
...
--	}
	...
	self.idleengine_ratios = {.9,.9,1.1,.9}
...
function Buggy:DropDriver()
	VC.DropDriver(self)
end

function Buggy:DropGunner()
	VC.DropGunner(self)
end

function Buggy:DropPassengers()
