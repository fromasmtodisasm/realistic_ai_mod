...
Paraglider = {
	...
	--
	DamageParams = {
		-- fDmgScaleAIBullet = .01,
		-- fDmgScaleAIExplosion = .7,
		fDmgScaleBullet = .01,
		fDmgScaleExplosion = .17,
	},
...
function Paraglider:OnCollide(hit)
	...
	if hit and hit.fSpeed and hit.fSpeed>.1 then
		VC.EveryoneOutForce(self)
	end
end
...
function Paraglider:DropDriver()
	VC.DropDriver(self)
end
