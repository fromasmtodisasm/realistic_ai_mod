...
Radio={
	...
	Properties = {
		...
		DeadParticles = {
			TimeDelay = .1, -- how often particle system is spawned.
...
function Radio:Event_Enter(sender)
	...
	self.Entered = 1 
	if (sender) then
		--System:Log("Player "..sender:GetName().." Enter RadioTrigger "..self:GetName())
	end
