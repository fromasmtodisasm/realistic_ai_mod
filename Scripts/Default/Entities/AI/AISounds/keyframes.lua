-- 1 парметр - название, второй - id кадра анимации, с которого начнётся воспроизведение (читай - время "посекундно"), 3 - воспроизводимый звук или что-то иное...
AI_ANIM_KEYFRAMES = {
	BASE_HUMAN_MODEL = {
		SoundEvents={
			{"srunfwd_start",8,KEYFRAME_ALLOW_AI_MOVE}, -- Это было закомментировано.
	...
	MUTANT_ABBERATION = {
		SoundEvents={
			...
			{"idle00",1,Sound:Load3DSound("SOUNDS/mutants/ab1/abidle3.wav",SOUND_UNSCALABLE,255,3,100)},
			{"idle01",1,Sound:Load3DSound("SOUNDS/mutants/ab1/abidle1.wav",SOUND_UNSCALABLE,255,3,100)},
			{"idle03",1,Sound:Load3DSound("SOUNDS/mutants/ab1/abidle2.wav",SOUND_UNSCALABLE,255,3,100)},
	...
	MUTANT_BIG = {
		SoundEvents={
			...
			{"attack_melee1",1,Sound:Load3DSound("SOUNDS/mutants/cover/exert_6.wav",SOUND_UNSCALABLE,255,3,100)},
			...
			{"attack_melee2",1,Sound:Load3DSound("SOUNDS/mutants/cover/exert_1.wav",SOUND_UNSCALABLE,255,3,100)},
			{"attack_melee3",10,Sound:Load3DSound("SOUNDS/mutants/cover/cover_melee3swipeF10.wav",SOUND_UNSCALABLE,175,2,60)},
			{"attack_melee3",1,Sound:Load3DSound("SOUNDS/mutants/cover/exert_2.wav",SOUND_UNSCALABLE,255,3,100)},
			...
			{"attack_melee4",1,Sound:Load3DSound("SOUNDS/mutants/cover/exert_4.wav",SOUND_UNSCALABLE,255,3,100)},
			{"attack_melee4",12,KEYFRAME_APPLY_MELEE},
			{"idle00",7,KEYFRAME_BREATH_SOUND},
			{"idle01",1,Sound:Load3DSound("SOUNDS/mutants/cover/exert_6.wav",SOUND_UNSCALABLE,255,3,100)},
			{"idle02",1,Sound:Load3DSound("SOUNDS/mutants/cover/exert_1.wav",SOUND_UNSCALABLE,255,3,100)},
			{"idle03",1,Sound:Load3DSound("SOUNDS/mutants/cover/exert_5.wav",SOUND_UNSCALABLE,255,3,100)},
			{"idle04",1,Sound:Load3DSound("SOUNDS/mutants/cover/exert_8.wav",SOUND_UNSCALABLE,255,3,100)},
	...
	MUTANT_STEALTH = {
		SoundEvents={
			...
			{"grenade",67,Sound:Load3DSound("SOUNDS/mutants/cover/exert_7.wav",SOUND_UNSCALABLE,255,5,60)},
		},
	},
	...
	MUTANT_FAST = {
		SoundEvents={
			...
			{"attack_melee1",3,Sound:Load3DSound("Sounds/Weapons/machete/fire1.wav",SOUND_UNSCALABLE,255,5,60)},
			{"attack_melee1",3,Sound:Load3DSound("SOUNDS/mutants/fast/exert1.wav",SOUND_UNSCALABLE,255,5,60)},
			...
			{"attack_melee2",21,Sound:Load3DSound("SOUNDS/mutants/fast/exert2.wav",SOUND_UNSCALABLE,255,5,60)},
			{"attack_melee2",17,KEYFRAME_APPLY_MELEE},
			{"attack_melee3",22,KEYFRAME_APPLY_MELEE},
			{"attack_melee3",3,Sound:Load3DSound("SOUNDS/mutants/fast/exert3.wav",SOUND_UNSCALABLE,255,5,60)},
