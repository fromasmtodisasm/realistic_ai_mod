Script:ReloadScript("Scripts/Default/Entities/Pickups/PickupPhysCommon.lua")
	...
	phys_item.Properties.Animation.Animation = "weapon_SmokeGrenade"
	phys_item.Properties.Animation.fAmmo_Primary = 1
	phys_item.Properties.Animation.sAmmotype_Primary="SmokeGrenade"
	...
	----
	----
	phys_item.Properties.object_Model = "Objects/pickups/grenade/grenade_smoke_pickup.cgf"
	...
	phys_item.weapon="SmokeGrenade"

	PickupSmokeGrenades_p = phys_item

function PickupSmokeGrenades_p:OnSave(stm)
...
function PickupSmokeGrenades_p:OnLoad(stm)
