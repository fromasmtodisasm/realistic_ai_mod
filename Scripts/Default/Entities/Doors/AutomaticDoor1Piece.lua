...
function AutomaticDoor1Piece:Event_Close(sender)
	...
	--System.ActivatePortal(self:GetPos(),0)
...
function AutomaticDoor1Piece:Event_Opened(sender)
	...
	--System.ActivatePortal(self:GetPos(),1)
...
AutomaticDoor1Piece["Server"]={
	...
	----------------------------------------------------------
		...
		OnLeaveArea=AutomaticDoor1Piece.OnLeaveArea,
	----------------------------------------------------------
	},
	------------------
	--CLOSED
	...
	Closed = {
		...
		OnContact = function(self,other)
			if (self.Properties.bAutomatic==1) then
				...
				if (self.Properties.bAutomatic==1 or (self.Properties.bAutomatic==0 and (other.ai and (other.MERC or other.IsAiPlayer or other.IsSpecOpsMan or other.MUTANT~="predator")))) and not self.EndReached then
					--self.GotoState("Opened")
