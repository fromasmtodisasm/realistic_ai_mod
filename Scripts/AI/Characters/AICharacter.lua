...
AICharacter = {
	AVAILABLE = {
		AiPlayer		= "Scripts/AI/Characters/Personalities/AiPlayer.lua",
		SpecOpsMan		= "Scripts/AI/Characters/Personalities/SpecOpsMan.lua",
		...
		CoverGuard		= "Scripts/AI/Characters/Personalities/CoverGuard.lua", -- Должно так и оставаться. Сделал так же, как и с поведением...
		...
		-- AISIndoorGuard	= "Scripts/AI/Characters/Personalities/AIS/AISIndoorGuard.lua",
		-- AISOutdoorGuard	= "Scripts/AI/Characters/Personalities/AIS/OutdoorGuard.lua",
...
System:Log("LOADED AI CHARACTERS")
