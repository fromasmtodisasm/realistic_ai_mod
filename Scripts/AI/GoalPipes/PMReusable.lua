...
--	AI:PushGoal("scout_tooclose_attack","hide",1,5,HM_NEAREST)
	...
	AI:CreateGoalPipe("AiPlayer_scramble_In_Attack")
	AI:PushGoal("AiPlayer_scramble_In_Attack","just_shoot")
	AI:PushGoal("AiPlayer_scramble_In_Attack","timeout",1,0,.5)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","setup_stand")
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","setup_crouch")
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","setup_crouch")
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","do_it_walking")
	AI:PushGoal("AiPlayer_scramble_In_Attack","locate",0,"atttarget")
	AI:PushGoal("AiPlayer_scramble_In_Attack","acqtarget",1,"")
	AI:PushGoal("AiPlayer_scramble_In_Attack","do_it_walking")
	AI:PushGoal("AiPlayer_scramble_In_Attack","timeout",1,0,.1)
	AI:PushGoal("AiPlayer_scramble_In_Attack","do_it_running")
	AI:PushGoal("AiPlayer_scramble_In_Attack","hide",1,60,HM_RANDOM,1)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","timeout",1,1,5)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","setup_prone")
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","do_it_walking")
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","signal",0,1,"AI_SETUP_DOWN",0)
	AI:PushGoal("AiPlayer_scramble_In_Attack","signal",0,1,"AI_SETUP_DOWN",0)
	AI:PushGoal("AiPlayer_scramble_In_Attack","timeout",1,5,20)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","timeout",1,1,15)
	AI:PushGoal("AiPlayer_scramble_In_Attack","signal",0,1,"AIPLAYER_ATTACK",0)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack","signal",0,1,"CHECK_FOR_FIND_A_TARGET",0)
	
	AI:CreateGoalPipe("AiPlayer_scramble_In_Attack2")
	AI:PushGoal("AiPlayer_scramble_In_Attack2","just_shoot")
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","timeout",1,.5)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","setup_prone")
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","do_it_walking")
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","hide",1,60,HM_FARTHEST,0)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","locate",0,"atttarget")
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","acqtarget",0,"")
	AI:PushGoal("AiPlayer_scramble_In_Attack2","do_it_walking")
	AI:PushGoal("AiPlayer_scramble_In_Attack2","timeout",1,0,.1)
	AI:PushGoal("AiPlayer_scramble_In_Attack2","do_it_running")
	AI:PushGoal("AiPlayer_scramble_In_Attack2","timeout",1,0,.1)
	AI:PushGoal("AiPlayer_scramble_In_Attack2","do_it_running")
	AI:PushGoal("AiPlayer_scramble_In_Attack2","hide",1,100,HM_FARTHEST,1)
	AI:PushGoal("AiPlayer_scramble_In_Attack2","hide",1,100,HM_FARTHEST_FROM_LASTOPRESULT,0)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","signal",0,1,"AI_SETUP_DOWN",0)
	AI:PushGoal("AiPlayer_scramble_In_Attack2","hide",1,100,HM_NEAREST_TO_LASTOPRESULT_NOSAME,0)
	AI:PushGoal("AiPlayer_scramble_In_Attack2","hide",1,100,HM_FARTHEST_FROM_LASTOPRESULT,0)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","signal",0,1,"AI_SETUP_DOWN",0)
	AI:PushGoal("AiPlayer_scramble_In_Attack2","signal",0,1,"AI_SETUP_UP",0)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","timeout",1,5,20)
	-- AI:PushGoal("AiPlayer_scramble_In_Attack2","signal",0,1,"AIPLAYER_ATTACK",0)
	AI:PushGoal("AiPlayer_scramble_In_Attack","signal",0,1,"CHECK_FOR_FIND_A_TARGET",0)
