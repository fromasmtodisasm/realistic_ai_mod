...
--	 AI:PushGoal("bezerker_rush","lookat",1,-10,10)
	AI:PushGoal("bezerker_rush","do_it_running")
...
--	AI:PushGoal("bezerker_attack_far","just_shoot")
	AI:PushGoal("bezerker_attack_far","do_it_running")
	...
	AI:PushGoal("bezerker_minimise_exposure","do_it_running")
...
--	AI:PushGoal("bezerker_aggresive_investigate","lookat",1,-10,10)
	AI:PushGoal("bezerker_aggresive_investigate","approach",1,.8)
	AI:PushGoal("bezerker_aggresive_investigate","timeout",1,.5,2)
...
--	AI:PushGoal("bezerker_scramble","just_shoot")
 ...
 --		AI:PushGoal("bezerker_scramble","timeout",1,1,5)
	...
	AI:PushGoal("bezerker_scramble","timeout",1,.5,1)
	AI:PushGoal("bezerker_scramble","signal",0,1,"MUTANT_NORMAL_ATTACK",0)

	AI:CreateGoalPipe("bezerker_stay")
	AI:PushGoal("bezerker_stay","not_shoot")
	AI:PushGoal("bezerker_stay","approach",0,.1)
	AI:PushGoal("bezerker_stay","timeout",0,.8)
	AI:PushGoal("bezerker_stay","backoff",0,.1)
 	AI:PushGoal("bezerker_stay","signal",0,1,"MUTANT_NORMAL_ATTACK",0)	
 	
 	AI:CreateGoalPipe("bezerker_backoff")
--	AI:PushGoal("bezerker_backoff","just_shoot")
