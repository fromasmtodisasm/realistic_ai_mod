...
--	AI:PushGoal("anchor_PutDown","trace",1,1)		
	...
	AI:PushGoal("anchor_PutDown","timeout",1,.8)
	AI:PushGoal("anchor_PutDown","signal",0,1,"UNBIND_CRATE",0)
	AI:PushGoal("anchor_PutDown","timeout",1,.5,1)
	AI:PushGoal("anchor_PutDown","setup_stand")
	AI:PushGoal("anchor_PutDown","signal",0,1,"FIND_ANCHOR",0)

	AI:CreateGoalPipe("PutDown")		
	AI:PushGoal("PutDown","timeout",1,.5,2)
	AI:PushGoal("PutDown","signal",0,1,"END_ANIM",0)
	AI:PushGoal("PutDown","timeout",1,.8)
	AI:PushGoal("PutDown","signal",0,1,"UNBIND_CRATE",0)
	AI:PushGoal("PutDown","timeout",1,.5,1)
	AI:PushGoal("PutDown","setup_stand")
...
--	AI:PushGoal("bind_crate","lookat",1,0,0)
	...
	AI:PushGoal("crouch","setup_crouch")
	...
	AI:PushGoal("approach_lookAround","approach",1,.1)
...
-- 	AI:PushGoal("animation_takeBreak","timeout",1,1.5)
	...
	AI:PushGoal("get_toolbox","setup_crouch")
	AI:PushGoal("get_toolbox","timeout",1,.5,1)
	AI:PushGoal("get_toolbox","setup_stand")
	...
	AI:PushGoal("anchor_indoorCar","approach",1,.5)
	...
	AI:PushGoal("get_toolbox_indoor","approach",1,.5)
	AI:PushGoal("get_toolbox_indoor","setup_crouch")
	AI:PushGoal("get_toolbox_indoor","timeout",1,.5,1)
	AI:PushGoal("get_toolbox_indoor","setup_stand")
	AI:PushGoal("get_toolbox_indoor","signal",0,1,"GOT_TOOLS",0)
	
	
	AI:CreateGoalPipe("anchor_traceChair")
	AI:PushGoal("anchor_traceChair","setup_stand")
	...
	AI:PushGoal("bindChair_trace","signal",0,1,"SITDOWN_ANIM",0)
 	--AI:PushGoal("bindChair_trace","timeout",1,.05)
...
--	AI:PushGoal("start_task","signal",0,1,"SITDOWN_ANIM",0)
	...
	AI:PushGoal("anchor_SitDown","signal",0,1,"SITDOWN_ANIM",0)
 	AI:PushGoal("anchor_SitDown","timeout",1,.05)
...
--	AI:PushGoal("anchor_SitDown","timeout",1,1)
	...
	AI:PushGoal("anchor_Seat","signal",0,1,"SITDOWN_ANIM",0)
 	AI:PushGoal("anchor_Seat","timeout",1,.05)
	...
	AI:PushGoal("anchor_SitDown_findAnchor","signal",0,1,"SITDOWN_ANIM",0)
 	AI:PushGoal("anchor_SitDown_findAnchor","timeout",1,.05)
...
--	AI:PushGoal("anchor_SitUp","setup_crouch")
--	AI:PushGoal("anchor_SitUp","setup_stand")
...
--	AI:PushGoal("devalue_anchor","timeout",1,.5)
	...
	AI:PushGoal("job_tagSet","do_it_walking")
	...
	AI:PushGoal("job_patrolPath","do_it_walking")
	...
	AI:PushGoal("patrol_random_walk","approach",0,.02)
