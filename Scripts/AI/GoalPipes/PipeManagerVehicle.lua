...
--	AI:PushGoal("h_drop","signal",0,1,"REINFORCMENT_OUT",0)
		...
		AI:CreateGoalPipe("a_h_drop")
		AI:PushGoal("a_h_drop","acqtarget",0,"")
		AI:PushGoal("a_h_drop","ignoreall",0,1)
		AI:PushGoal("a_h_drop","approach",0,1)
		-- AI:PushGoal("a_h_drop","timeout",1,1,10)

		AI:CreateGoalPipe("h_ignore_collisions")
		AI:PushGoal("h_ignore_collisions","bodypos",0,1)

		AI:CreateGoalPipe("h_not_ignore_collisions")
		AI:PushGoal("h_not_ignore_collisions","bodypos",0,0)

		AI:CreateGoalPipe("a_h_timeout_readytogo")
		AI:PushGoal("a_h_timeout_readytogo","ignoreall",0,1)
		AI:PushGoal("a_h_timeout_readytogo","timeout",1,1)
		AI:PushGoal("a_h_timeout_readytogo","h_not_ignore_collisions")
		AI:PushGoal("a_h_timeout_readytogo","h_attack_stop")
		AI:PushGoal("a_h_timeout_readytogo","timeout",1,1)
		AI:PushGoal("a_h_timeout_readytogo","signal",0,1,"READY_TO_GO",0)
...
-- to be hit by car
		...
		AI:PushGoal("h_goto_patrol","signal",0,1,"FLY",0) -- Поддержание высоты.
...
--		AI:PushGoal("h_gunner_fire","signal",1,-1,"MAKE_ME_UNIGNORANT",0)
		AI:PushGoal("h_gunner_fire","just_shoot")
		AI:PushGoal("h_gunner_fire","timeout",1,1)

		AI:CreateGoalPipe("h_gunner_no_fire")
		AI:PushGoal("h_gunner_no_fire","not_shoot")
		AI:PushGoal("h_gunner_no_fire","timeout",1,1)
...
--		AI:PushGoal("h_standingthere","ignoreall",0,1)
		AI:PushGoal("h_standingthere","not_shoot")
		AI:PushGoal("h_standingthere","stick",0,-1) -- походу "прикелиться к земле"
--		AI:PushGoal("h_standingthere","lookat",0,0,0)
		...
		AI:PushGoal("h_standingtherestill","not_shoot")
--		AI:PushGoal("h_standingthere","lookat",0,0,0)
		...
		-- does not see player - make short strafe than try to advance for better position Если не видит игрока, то лучше сделать короткий стрейф в сторону, чем пытаться продвигаться к лучшей позиции
...
--		AI:PushGoal("h_user_getout","just_shoot")
		AI:PushGoal("h_user_getout","acqtarget",0,"")
		AI:PushGoal("h_user_getout","do_it_running")
...
--		AI:PushGoal("h_user_getout","strafe",0,-1)
		...
		AI:PushGoal("h_user_getout","signal",0,1,"exited_vehicle2",0)

-- ______________________________________________________________________________________________________________________
---------------------------------------------------- CAR ----------------------------------------------------
		AI:CreateGoalPipe("c_brake")
--		AI:PushGoal("c_brake","jump",1,1)
		AI:PushGoal("c_brake","strafe",0,1)					-- тормозить
		AI:PushGoal("c_brake","timeout",1,.7)
...
--		AI:PushGoal("c_goto","ignoreall",0,1)
		AI:PushGoal("c_goto","strafe",0,0)						-- остановить торможение
		...
		AI:PushGoal("c_goto_ignore","strafe",0,0)						-- остановить торможение
		...
		AI:PushGoal("c_runover","strafe",0,0)						-- остановить торможение
		AI:PushGoal("c_runover","bodypos",0,1)		-- Для обновления пути во время движения (погоня)
...
--		AI:PushGoal("c_runover","signal",0,1,"next_point",0)
		...
		AI:PushGoal("c_standingthere","strafe",0,1)	-- тормозить
...
--		AI:PushGoal("c_driver","lookat",0,0,0)
		...
		AI:PushGoal("c_driver","not_shoot")

		AI:CreateGoalPipe("c_getout")
		AI:PushGoal("c_getout","timeout",1,.1)
		AI:PushGoal("c_getout","not_shoot")
		AI:PushGoal("c_getout","signal",0,1,"MAKE_OBSERVE",0)

		AI:CreateGoalPipe("c_goto_path")
--		AI:PushGoal("c_goto_path","ignoreall",0,1)
		AI:PushGoal("c_goto_path","strafe",0,0)						-- остановить торможение
		...
		AI:PushGoal("c_approach_n_drop","strafe",0,0)						-- остановить торможение
...
--		AI:PushGoal("b_stick","timeout",1,.7)
		...
		AI:PushGoal("b_standingthere","not_shoot")
--		AI:PushGoal("h_standingthere","lookat",0,0,0)

		AI:CreateGoalPipe("b_user_getout")
		AI:PushGoal("b_user_getout","acqtarget",0,"")
		AI:PushGoal("b_user_getout","not_shoot")
		AI:PushGoal("b_user_getout","approach",1,1.1)
		AI:PushGoal("b_user_getout","signal",0,-1,"exited_vehicle2",0)

		AI:CreateGoalPipe("b_user_getin") -- Положение тела устанавливается в VehicleCommon.lua
		...
		AI:PushGoal("b_user_getin","not_shoot")
		AI:PushGoal("b_user_getin","timeout",1,.1)
		AI:PushGoal("b_user_getin","do_it_running")
		AI:PushGoal("b_user_getin","signal",1,-1,"GET_IN_VEHICLE",SIGNALID_READIBILITY)
		AI:PushGoal("b_user_getin","approach",1,.1)
		-- AI:PushGoal("b_user_getin","signal",1,-1,"FORCE_GET_IN_VEHICLE") -- Добавил.
		...
		AI:CreateGoalPipe("b_user_getin2")
		AI:PushGoal("b_user_getin2","ignoreall",0,1)
		AI:PushGoal("b_user_getin2","signal",1,-1,"MAKE_ME_IGNORANT",0)
		AI:PushGoal("b_user_getin2","acqtarget",0,"")
		AI:PushGoal("b_user_getin2","not_shoot")
		AI:PushGoal("b_user_getin2","timeout",1,.1)
		AI:PushGoal("b_user_getin2","do_it_running")
		AI:PushGoal("b_user_getin2","pathfind",1,"") -- Так лучше.
		AI:PushGoal("b_user_getin2","trace",1,1,0)
		AI:PushGoal("b_user_getin2","signal",1,-1,"MAKE_ME_UNIGNORANT",0)
		AI:PushGoal("b_user_getin2","signal",1,1,"at_boatenterspot",0)
		AI:PushGoal("b_user_getin2","timeout",1,1000)

		AI:CreateGoalPipe("b_timeout")
		AI:PushGoal("b_timeout","ignoreall",0,1)
		AI:PushGoal("b_timeout","not_shoot")
