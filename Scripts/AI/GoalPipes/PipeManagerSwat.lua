...
-- -------------------------------------------------- SWAT SCRIPTS ----------------------------------------------------
	...
	AI:PushGoal("swat_huntLostPlayer","setup_stand")
...
--	AI:PushGoal("swat_huntLostPlayer","lookat",1,-5,5)
	AI:PushGoal("swat_huntLostPlayer","do_it_running")
...
-- 	AI:PushGoal("swat_huntLostPlayer","signal",0,1,"swat_attack",0) -- start proper action there
	...
	AI:PushGoal("swat_noHide","setup_crouch")
	AI:PushGoal("swat_noHide","just_shoot") 
...
--	AI:PushGoal("swat_noHide","approach",0,1)
	...
	AI:PushGoal("swat_attentive","setup_stand")
	...
	AI:PushGoal("swat_investigate","do_it_walking")
	AI:PushGoal("swat_investigate","bodypos",1,5)
	AI:PushGoal("swat_investigate","timeout",1,.5,.75)
	...
	AI:PushGoal("swat_approach_threat","do_it_running")
	AI:PushGoal("swat_approach_threat","hide",1,10,HM_NEAREST)
	AI:PushGoal("swat_approach_threat","timeout",1,.5,1)
	AI:PushGoal("swat_approach_threat","do_it_walking")
	...
	AI:PushGoal("swat_advance","do_it_running")
	...
	AI:PushGoal("swat_advance","timeout",1,.3)
	...
	AI:PushGoal("swat_singleadvance","do_it_running")
	...
	--AI:PushGoal("swat_trace_sender","timeout",1,.5,.85)
	...
	AI:PushGoal("swat_trace_sender","timeout",1,.3)
	...
	AI:PushGoal("swat_attack_advance","do_it_running")
	...
	AI:PushGoal("swat_goforcover","do_it_running")
	...
	AI:PushGoal("swat_coverattack","do_it_running")
	AI:PushGoal("swat_coverattack","not_shoot")
	...
	AI:PushGoal("swat_coverattack_nearest","do_it_running")
	AI:PushGoal("swat_coverattack_nearest","not_shoot")
	...
	AI:PushGoal("swat_comeout","do_it_running")
	AI:PushGoal("swat_comeout","setup_stand")
	AI:PushGoal("swat_comeout","approach",1,.9)
	AI:PushGoal("swat_comeout","just_shoot")
	AI:PushGoal("swat_comeout","timeout",1,.7,1.3)
	AI:PushGoal("swat_comeout","not_shoot")
	...
	AI:PushGoal("swat_takeleftcover","do_it_running")
	AI:PushGoal("swat_takeleftcover","hide",1,10,HM_LEFTMOST_FROM_TARGET)
	AI:PushGoal("swat_takeleftcover","approach",1,.9)
	AI:PushGoal("swat_takeleftcover","just_shoot")
	AI:PushGoal("swat_takeleftcover","timeout",1,.7,1.3)
	...
	AI:PushGoal("swat_takerightcover","do_it_running")
	AI:PushGoal("swat_takerightcover","hide",1,10,HM_RIGHTMOST_FROM_TARGET)
	AI:PushGoal("swat_takerightcover","approach",1,.9)
	AI:PushGoal("swat_takerightcover","just_shoot")
	AI:PushGoal("swat_takerightcover","timeout",1,.7,1.3)
	...
	AI:PushGoal("swat_comeout_rollleft","not_shoot")
	AI:PushGoal("swat_comeout_rollleft","bodypos",1,0)
	AI:PushGoal("swat_comeout_rollleft","do_it_walking")
	...
	AI:PushGoal("swat_comeout_rollleft","timeout",1,.2)
	AI:PushGoal("swat_comeout_rollleft","strafe",0,0)
	AI:PushGoal("swat_comeout_rollleft","just_shoot")
	...
	AI:PushGoal("swat_comeout_rollright","not_shoot")
	AI:PushGoal("swat_comeout_rollright","bodypos",1,0)
	AI:PushGoal("swat_comeout_rollright","do_it_walking")
	...
	AI:PushGoal("swat_comeout_rollright","timeout",1,.2)
	AI:PushGoal("swat_comeout_rollright","strafe",0,0)
	AI:PushGoal("swat_comeout_rollright","just_shoot")
	...
	AI:PushGoal("swat_comeout_right","not_shoot")
	AI:PushGoal("swat_comeout_left","bodypos",1,0)
	AI:PushGoal("swat_comeout_left","do_it_walking")
...
--	AI:PushGoal("swat_comeout_left","lookat",-10,10)
	...
	AI:PushGoal("swat_comeout_left","just_shoot")
	AI:PushGoal("swat_comeout_left","timeout",1,1.5,2.5)
	AI:PushGoal("swat_comeout_left","not_shoot")
	...
	AI:PushGoal("swat_comeout_right","do_it_walking")
...
--	AI:PushGoal("swat_comeout_left","lookat",10,-10)
	...
	AI:PushGoal("swat_comeout_right","just_shoot")
	...
	AI:PushGoal("swat_crouchcomeout_left","not_shoot")
	AI:PushGoal("swat_crouchcomeout_left","do_it_walking")
	...
	AI:PushGoal("swat_crouchcomeout_left","just_shoot")
	...
	AI:PushGoal("swat_crouchcomeout_right","not_shoot")
	AI:PushGoal("swat_crouchcomeout_right","do_it_walking")
	...
	AI:PushGoal("swat_crouchcomeout_right","just_shoot")
	...
	AI:PushGoal("swat_standup","not_shoot")
	AI:PushGoal("swat_standup","do_it_walking")
	AI:PushGoal("swat_standup","Trace_Anchor")
	AI:PushGoal("swat_standup","bodypos",1,0)
	AI:PushGoal("swat_standup","just_shoot")
	...
	AI:PushGoal("swat_kneelattack","do_it_running")
	...
	AI:PushGoal("swat_kneelattack","timeout",1,.3)
	AI:PushGoal("swat_kneelattack","just_shoot")
	...
	AI:PushGoal("swat_kneelattack","timeout",1,.7,1.3)
	AI:PushGoal("swat_kneelattack","signal",0,1,"kneel_end_animation",0)
	AI:PushGoal("swat_kneelattack","timeout",1,1)
	AI:PushGoal("swat_kneelattack","not_shoot")
