...
-- -------------------------------------------------- SHARED SCRIPTS ----------------------------------------------------
		...
		AI:PushGoal("AIS_TeamMemberDiedIndoor","do_it_running")
		...
		AI:PushGoal("AIS_InvestigateSenderTarget","setup_stand")
		AI:PushGoal("AIS_InvestigateSenderTarget","do_it_running")
		...
		AI:PushGoal("AIS_investigateThreatIndoor","do_it_running")
		...
		AI:PushGoal("AIS_GuardTraceAttack","just_shoot")
		AI:PushGoal("AIS_GuardTraceAttack","do_it_running")
		AI:PushGoal("AIS_GuardTraceAttack","setup_stand")
		AI:PushGoal("AIS_GuardTraceAttack","locate",1,"atttarget")
		AI:PushGoal("AIS_GuardTraceAttack","timeout",1,.1)
		...
		AI:PushGoal("AIS_StandAttack","do_it_walking")
