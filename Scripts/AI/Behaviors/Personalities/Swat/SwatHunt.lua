...
AIBehaviour.SwatHunt = {
	...
	OnEnemySeen = function(self,entity)
		...
		System:Log("["..entity:GetName().."]+SwatHunt++++++++++++. OnEnemySeen")
	end,
	---------------------------------------------
...
--		System:Log("["..entity:GetName().."]+SwatHunt++++++++++++ OnEnemyMemory")
		entity:SelectPipe(0,"swat_huntLostPlayer")
	end,
	---------------------------------------------
	OnInterestingSoundHeard = function(self,entity)
		--System:Log("+++++++++++++++++++HUNT interesting sound")
		--System:Log("inserting subpipe now ---------------------------")
		entity:SelectPipe(0,"swat_investigate")
	--	entity:InsertSubpipe(0,"scout_dropebeacon_and_target")
	end,
	---------------------------------------------
	OnThreateningSoundHeard = function(self,entity)
		--System:Log("+++++++++++++++++++HUNT threatening sound")
		entity:SelectPipe(0,"swat_investigate")
