...
--		System:Log("["..entity:GetName().."]+SwatThreatened++++++++++ OnEnemyMemory")
...
--		System:Log("["..entity:GetName().."]+SwatThreatened++++++++++ OnNoHidingPlace")
...
--		System:Log("++++++++++++++threatened "..entity:GetName().." received ENEMY_SPOTTED")
		if (entity~=sender) then 
