...
--		System:Log("["..entity:GetName().."]+SwatGroupWait++++++++++++ OnPlayerSeen [<15]in "..fDistance)
...
--		System:Log("["..entity:GetName().."]+SwatGroupWait+++++++++++. OnEnemySeen")
	end,
	---------------------------------------------
	OnEnemyMemory = function(self,entity,fDistance,NotContact)
--		System:Log("["..entity:GetName().."]+SwatGroupWait++++++++++++ OnEnemyMemory ")
