...
--		System:Log("["..entity:GetName().."]+SwatAttack++++++++ATTACK OnPlayerSeen: fDistance ["..fDistance .."]")
...
--		System:Log("["..entity:GetName().."]+SwatAttack+++++++++++. OnEnemySeen")
	end,
	---------------------------------------------
...
--		System:Log("["..entity:GetName().."]+SwatAttack++++++++++++ATTACK OnEnemyMemory")
...
--		System:Log("["..entity:GetName().."]+SwatAttack+++++++++OnNoHidingPlace")
...
--			System:Log("["..entity:GetName().."]+SwatAttack++++++++signal [".. combatAnchor.signal.."]")
			entity:SelectPipe(0,combatAnchor.signal,combatAnchor.found)
		else
--			System:Log("["..entity:GetName().."]+SwatAttack+++++++signal no anchor")
