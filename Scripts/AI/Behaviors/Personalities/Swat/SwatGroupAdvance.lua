...
AIBehaviour.SwatGroupAdvance = {
	...
	OnPlayerSeen = function(self,entity,fDistance,NotContact)
		System:Log("["..entity:GetName().."]+SwatGroupAdvance++++++++++ OnPlayerSeen in "..fDistance)
	...
	OnNoHidingPlace = function(self,entity,sender)
		...
		System:Log("["..entity:GetName().."]+SwatGroupAdvance++++++++++++ OnNoHidingPlace")
	...
	SUSPRESSION_FIRE  = function(self,entity,sender)
		...
		if (entity~=sender) then 
			System:Log(entity:GetName().." .. SUSPRESSION_FIRE")
			entity:InsertSubpipe(0,"swat_suspress")
		end
	end,
	--------------------------------------------------	
