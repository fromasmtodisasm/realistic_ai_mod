...
AIBehaviour.TLFakeAttack = {
	...
	OnActivate = function(self,entity)
		...
		AI:PushGoal(entity.Properties.pathname.."AIS_ChasePath","do_it_running")
		AI:PushGoal(entity.Properties.pathname.."AIS_ChasePath","bodypos",1,0)
		AI:PushGoal(entity.Properties.pathname.."AIS_ChasePath","just_shoot")
	...
	OnGroupMemberDied = function(self,entity)
		...
		local grpcnt = entity:GetGroupCount()
		if (grpcnt < 3) then
