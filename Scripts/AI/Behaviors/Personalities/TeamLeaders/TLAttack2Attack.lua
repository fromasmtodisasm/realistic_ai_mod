...
AIBehaviour.TLAttack2Attack = {
	...
	OnPlayerSeen = function(self,entity,fDistance,NotContact)
		...
		local count = entity:GetGroupCount()
		if (count > 1) then
	...
	RED_IN_POSITION = function(self,entity,sender)
		...
		if not entity.redpos then entity.redpos=0 end
		if not entity.redteammembers then entity.redteammembers=0 end
		entity.redpos = entity.redpos+1 
		System:Log("Reds in position ".. entity.redpos.." and members "..entity.redteammembers)
	...
	BLACK_IN_POSITION = function(self,entity,sender)
		-- some member of the group is safely in position
		if not entity.blackpos then entity.blackpos=0 end
		if not entity.blackteammembers then entity.blackteammembers=0 end
		entity.blackpos = entity.blackpos+1 
		System:Log("Blacks in position ".. entity.blackpos.." and members "..entity.blackteammembers)
