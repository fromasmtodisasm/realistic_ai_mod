...
AIBehaviour.Pig = {
	...
	OnSpawn = function(self,entity)
		...
		AI:PushGoal("pig_wander","approach",1,.5)
		...
		AI:PushGoal("pig_scared_hide","do_it_running")
		AI:PushGoal("pig_scared_hide","hide",1,20,HM_FARTHEST_FROM_TARGET,1)
		AI:PushGoal("pig_scared_hide","do_it_walking")
	...
	---------------------------------------------
	OnSomethingDiedNearest = function(self,entity)
		entity:SelectPipe(0,"pig_scared_hide")
	end,
	---------------------------------------------
