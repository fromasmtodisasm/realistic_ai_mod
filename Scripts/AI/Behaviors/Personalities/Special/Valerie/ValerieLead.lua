...
AIBehaviour.ValerieLead = {
	...
	OnCloseContact = function(self,entity,sender)
		...
		if (entity.LEADING==nil) then
			...
			if (entity.LEADING_COUNT==nil) then 
				entity.LEADING_COUNT = 0 
			end

			local tgPoint =entity:GetName().."_LEAD"..entity.LEADING_COUNT 
			if (Game:GetTagPoint(tgpoint)) then 
				entity.LEADING = 1 
				entity:SelectPipe(0,"val_lead_to",tgPoint)
				entity.LEADING_COUNT=entity.LEADING_COUNT+1  
			end
	...
	YOU_CAN_APPROACH_TO_NEXT = function(self,entity,sender)
		...
		--System:Log("\001 SIGNAL RECVD")		
		entity.LEADING=nil 
		entity:SelectPipe(0,"standingthere")
		entity:InsertSubpipe(0,"just_shoot")
		Hud:AddMessage(entity:GetName()..": YOU_CAN_APPROACH_TO_NEXT1")
	end,
