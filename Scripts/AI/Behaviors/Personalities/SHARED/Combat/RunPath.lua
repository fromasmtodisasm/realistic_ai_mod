...
AIBehaviour.RunPath = {
	...
	OnSpawn = function(self,entity)
		...
		AI:PushGoal(entity.Properties.pathname.."RunPath","do_it_running")
		AI:PushGoal(entity.Properties.pathname.."RunPath","setup_stand")
		AI:PushGoal(entity.Properties.pathname.."RunPath","just_shoot")
...
--	System:Log("\001"..entity:GetName().."+++++++++++++++++ RunToAlarm OnActivate")
		entity:SelectPipe(0,entity.Properties.pathname.."RunPath")	
	end,
	---------------------------------------------
