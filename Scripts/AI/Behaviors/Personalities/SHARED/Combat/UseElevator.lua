...
AIBehaviour.UseElevator = {
	...
	OnSpawn = function(self,entity)
		...
		AI:PushGoal(entity.Properties.pathname.."UseElevator","do_it_running")
		AI:PushGoal(entity.Properties.pathname.."UseElevator","setup_stand")
		AI:PushGoal(entity.Properties.pathname.."UseElevator","just_shoot")
