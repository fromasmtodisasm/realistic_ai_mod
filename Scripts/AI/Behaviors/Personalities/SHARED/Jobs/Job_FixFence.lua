...
--System:Log("\003["..entity:GetName() .."] Job_FixFence<<<<<<<<<<<<<<<duration["..duration.."]")
 ...
 --	System:Log("\003["..entity:GetName() .."] Job_FixFence<<<<<<<<<<<<<<<OnBored")
...
--	System:Log("\003["..entity:GetName() .."] Job_FixFence<<<<<<<<<<<<<<<OnJobExit")
...
--	System:Log("\003["..entity:GetName() .."] Job_FixFence<<<<<<<<<<<<<<< IDLE_ANIMATION")
...
--	System:Log("\003["..entity:GetName() .."] Job_FixFence<<<<<<<<<<<<<<< START_ANIM")
...
--	System:Log("\003["..entity:GetName() .."] Job_FixFence <<<<<<<<<<<<<<<LOOP_ANIM")
...
--	System:Log("\003["..entity:GetName() .."] Job_FixFence <<<<<<<<<<<<<<<END_ANIM")
	...
	DECISION_POINT = function(self,entity,sender)
		...
		if (rnd==1) then
--		             System:Log("\003["..entity:GetName() .."] Job_FixFence <<<<<<<<<<<<<<<idle_ANIM")
