...
AIBehaviour.Job_StandIdle = {
	...
	OnSpawn = function(self,entity)
		-- Hud:AddMessage(entity:GetName()..": Job_StandIdle/OnSpawn")
		if not entity.OnConversationFinishedStart then -- Чтобы после разговора не срабытывало, а то перебивает.
