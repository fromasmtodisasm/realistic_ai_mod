...
--	System:Log("\003["..entity:GetName() .."]++++++++++++spawned MutantJob_RndTag")
 ...
 --			System:Log("\003["..entity:GetName() .."]+++++++++++++ifle anim ["..MyAnim.Name.."]")
			-----	
			AI:CreateGoalPipe(MyAnim.Name.."Delay")
			AI:PushGoal(MyAnim.Name.."Delay","timeout",1,MyAnim.duration)
			AI:PushGoal(MyAnim.Name.."Delay","timeout",1,.5,1.5)
...
--		System:Log("\003["..entity:GetName() .."]+++++++++++++path step ["..entity.Properties.pathname..rnd.."]")
