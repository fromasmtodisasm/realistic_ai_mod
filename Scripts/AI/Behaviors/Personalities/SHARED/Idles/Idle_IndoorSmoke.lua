...
AIBehaviour.Idle_IndoorSmoke = {
	...
	FIND_ANCHOR = function(self,entity)
		...
		local foundObject = AI:FindObjectOfType(entity.id,10,self.TargetType)
 		if (foundObject) then
--			System:Log("++++++++++++++++++++++++++++ [".. entity:GetName() .."] FIND_ANCHOR FoundObject ["..self.FoundObject .. "]")
