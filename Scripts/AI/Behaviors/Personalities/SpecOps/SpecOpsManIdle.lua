AIBehaviour.SpecOpsManIdle = {
	...
	OnPlayerSeen = function(self,entity,fDistance,NotContact)
		...
		elseif entity.IsSpecOpsMan=="Dooch" then -- Это Дуч, славный малый. Патологически обожает взрывы. Кажется, у него даже под подушкой всегда лежит граната. Просто, на всякий случай.
