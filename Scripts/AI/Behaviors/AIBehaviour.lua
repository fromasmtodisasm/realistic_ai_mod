...
AIBehaviour = {
	AVAILABLE = {
		...
		Job_LookPatrol		= "Scripts/AI/Behaviors/Personalities/SHARED/Jobs/Job_LookPatrol.lua",
		-- STANDING
	...
	INTERNAL = {
		...
		CoverGuardIdle      = "Scripts/AI/Behaviors/Personalities/Guards/CoverGuardIdle.lua", -- Присвоил в том файле поведение обычного Кавера.
		-- CoverGuardIdle		= "Scripts/AI/Behaviors/Personalities/Cover/CoverIdle.lua", -- Так почему-то стандартное поведение не знает. Это от того, что берёт название от характера (AICharacter) "CoverGuard", добавляет вконце Idle, и в таком виде обращается к файлу "CoverGuardIdle.lua". Можно и на стадии ресета подменить характер, но тогда нужна перезагрузка уровня.
		-- REAR
		...
		-- SpecOps
		SpecOpsManIdle		= "Scripts/AI/Behaviors/Personalities/SpecOps/SpecOpsManIdle.lua",
		-- AI PLAYER
		AIPlayerIdle		= "Scripts/AI/Behaviors/Personalities/AiPlayer/AIPlayerIdle.lua",
		-- VEHICLES
		...
		FastAlert			= "Scripts/AI/Behaviors/Personalities/Mutants/Fast/FastAlert.lua",
		...
		BigAlert			= "Scripts/AI/Behaviors/Personalities/Mutants/Big/BigAlert.lua",
		...
		ChimpAlert			= "Scripts/AI/Behaviors/Personalities/Mutants/Chimp/ChimpAlert.lua",
		...
		SniperAttack		= "Scripts/AI/Behaviors/Personalities/Sniper/SniperAttack.lua",
		SniperAlert			= "Scripts/AI/Behaviors/Personalities/Sniper/SniperAlert.lua",
		SniperE3			= "Scripts/AI/Behaviors/Personalities/Sniper/SniperE3.lua",
		...
		EntityGrenadeSeen	= "Scripts/AI/Behaviors/Personalities/SHARED/Combat/EntityGrenadeSeen.lua",
		...
		SearchAmmunition	= "Scripts/AI/Behaviors/Personalities/SHARED/Other/SearchAmmunition.lua",
		ClimbLadder			= "Scripts/AI/Behaviors/Personalities/SHARED/Other/ClimbLadder.lua",
	},
}
System:Log("LOADED AI BEHAVIOURS")
