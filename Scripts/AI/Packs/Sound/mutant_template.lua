...
--------------------------
SOUNDPACK.mutant_template = {
-----------------------------------------------------------------------------------
	CHATTERING = {
	-- general background mutant type muttering, creepiness good 
				{
				PROBABILITY = 1000,
				soundFile = "SOUNDS/radiovoices/rchatter1.wav",
				Volume = 160,
				min = 4,
				max = 30,
				sound_unscalable = 0,
...
-----------------------------------------------------------------------------------
	...
	-- sad ballad of death - eg. aaaaaaaaaaggghhhh! oh... Im dieing tell .....
				{
				PROBABILITY = 1000,
				soundFile = "SOUNDS/e3ai/death/ahhhggg.wav",
				Volume = 160,
				min = 4,
				max = 30,
				sound_unscalable = 0,
...
------------------------------------------------------------------------------------
	...
	--eg. "There!", "Intruder"
				{
				PROBABILITY = 250,
				soundFile = "SOUNDS/nov_dialog/75.wav",
				Volume = 125,
				min = 2,
				max = 300,
				sound_unscalable = 0,
...
------------------------------------------------------------------------------------
	...
	--eg. "Someones shooting at me !"
				{
				PROBABILITY = 50,
				soundFile = "SOUNDS/nov_dialog/105.wav",
				Volume = 125,
				min = 2,
				max = 300,
				sound_unscalable = 0,
